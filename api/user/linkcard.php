<?php
    ...
    if (!property_exists($data,'email') || !property_exists($data,'cardnumber')|| !property_exists($data,'cccd') || !property_exists($data,'name') || !property_exists($data,'type')){
    ...
    linkCard($email,$cardnumber,$cccd,$name,$type);
?>