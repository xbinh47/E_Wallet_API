<?php
    ...
    if (!property_exists($data,'email') || !property_exists($data,'networkname')|| !property_exists($data,'price') || !property_exists($data,'passtrans')){
    ...
    topupCard($email,$networkname,$price,$passtrans);  
?>